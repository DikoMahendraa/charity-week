...
function EmptyState() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#F7F9FB] text-center px-6">
      ...
      <h1 className="text-xl font-bold text-[#161616]">About page not published yet</h1>
      <p className="text-sm text-gray-400 max-w-xs">
        Select the "About" tab in the CMS, build your page with blocks, then click Save Changes.
      </p>
      <Link
        href="/site/cms"
...
export default function AboutPage() {
  ...
  useEffect(() => {
    const published = loadPublished("about");
